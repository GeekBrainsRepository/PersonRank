...
public class EditElementPanelClass extends WindowDialog{
    static void editElementPanel(){
        panel();
    }

    private static void panel(){
        editElementPanel.setLayout(null);
        ...
        editElementPanel.add(name);
        editElementPanel.add(enterText);
        editElementPanel.add(save);
        editElementPanel.add(decline);
    }
}
