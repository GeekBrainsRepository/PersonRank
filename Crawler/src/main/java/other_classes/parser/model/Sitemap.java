package other_classes.parser.model;
...
public final class Sitemap {
    ...
    public Sitemap(Set<SitemapIndex> sitemapIndexes, Set<SitemapEntry> sitemapEntries, SitemapType sitemapType) {
        this.sitemapIndexes = Collections.unmodifiableSet(new LinkedHashSet<SitemapIndex>(sitemapIndexes));
        this.sitemapEntries = Collections.unmodifiableSet(new LinkedHashSet<SitemapEntry>(sitemapEntries));
        if (sitemapType == null) {
    ...
    public Sitemap getSitemapMatchingUrl(String url) {
        ...
        Set<SitemapEntry> sitemapEntriesMatchingUrl = new LinkedHashSet<SitemapEntry>();
    ...
    public Sitemap getSitemapModifiedAfter(Date minLastMod) {
        Set<SitemapIndex> sitemapIndexesModifiedAfter = new LinkedHashSet<SitemapIndex>();
        ...
        Set<SitemapEntry> sitemapEntriesModifiedAfter = new LinkedHashSet<SitemapEntry>();
        for (SitemapEntry sitemapEntry : sitemapEntries) {
    ...
    public Sitemap getSitemapWithChangeFreq(EnumSet<SitemapEntry.ChangeFreq> changeFrequencies) {
        Set<SitemapEntry> sitemapEntriesChangeFreq = new LinkedHashSet<SitemapEntry>();
        for (SitemapEntry sitemapEntry : sitemapEntries) {
    ...
    public Sitemap getSitemapWithMinPriority(double priority) {
        Set<SitemapEntry> sitemapEntriesMinPriority = new LinkedHashSet<SitemapEntry>();
        for (SitemapEntry sitemapEntry : sitemapEntries) {
